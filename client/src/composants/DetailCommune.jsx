...
function DetailCommune() {
  ...
  return (
    ...
    <div className='row ' style={{padding:10}}>
        ...
        <h2>Liste des fokotany de Commune : <strong>Antehiroka</strong></h2>
        <div  className="card col-md-4" style={{width:245,height:50, marginLeft:10,marginTop:10
                    }}>
                        
                    <div className="card-body">
                        <Link style={{textDecoration:'none'}} to={`/DistrictRegion/`} ><h5 className="card-title">Ambohibao</h5></Link>
                    </div>
                </div>
                <div  className="card col-md-4" style={{width:245,height:50, marginLeft:10,marginTop:10
                    }}>
                    ...
                    <div className="card-body">
                        <Link style={{textDecoration:'none'}} to={`/DistrictRegion/`} ><h5 className="card-title">Andranoro</h5></Link>
                    </div>
                </div>
                <div  className="card col-md-4" style={{width:245, height:50,marginLeft:10,marginTop:10
                    }}>
                    ...
                    <div className="card-body">
                        <Link style={{textDecoration:'none'}} to={`/DistrictRegion/`} ><h5 className="card-title">Ambohijanahary</h5></Link>
                    </div>
                </div>
